...
<head>
    ...
    <title>Student Registration - Bill Payment</title>
...
<body class="bodyMain">
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <p class="fontTopic">Bill Payment</p>
        </div>
    </div>
    <br><br>
    <div class="container">
    ...
    <div class="container">
        <div class="backgroundMain">
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <p class="fontBill">Payment ID: <?php echo $_SESSION['paymentid'][$_SESSION['billnum']] ?></p>
                </div>
                <div class="col"></div>
            </div>
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <p class="fontBill">Enrollment ID: <?php echo $_SESSION['enrollmentid'] ?></p>
                </div>
                <div class="col"></div>
            </div>
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <p class="fontBill">Student ID: <?php echo $_SESSION['uid'] ?></p>
                </div>
                <div class="col"></div>
            </div>
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <p class="fontBill">Price: <?php echo $_SESSION['billprice'] ?></p>
                </div>
                <div class="col"></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <form action="pay_db.php" method="post">
                        <div class="row">
                            <div class="col-auto">
                                <p class="fontBill">Transition Number: </p>
                            </div>
                            <div class="col">
                                <input class="form-control" id="" placeholder="Type here..." name="transitionnum" required>
                            </div>
                            <div class="col-auto">
                                <div class="font">
                                    <button type="submit" class="btn btn-outline-success" name="pay">Confirm</button>
                                </div>
