...
<head>
    ...
    <title>Student Registration - Edit User Infomation</title>
...
<body class="bodyMain">
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <p class="fontTopic">Modify User Infomation</p>
        </div>
    </div>
    <br>
    <div class="container">
        ...
        <br>
            <form action="edituser_db.php" method="post">
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                            <label for="" class="fontNew">First Name:</label>
                            <input type="text" class="form-control" name="editfname" placeholder="Type here..." >
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                            <label for="" class="fontNew">Last Name:</label>
                            <input type="text" class="form-control" name="editlname" placeholder="Type here..." >
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                            <label for="" class="fontNew">Password:</label>
                            <input type="password" class="form-control" name="editpw" placeholder="Type here..." >
                    </div>
                </div>
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                            <label for="" class="fontNew">Re-Password:</label>
                            <input type="password" class="form-control" name="repw" placeholder="Type here..." >
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="fontCenter">
                        <button type="submit" class="btn btn-primary" name="edituser">Confirm</button>
                    </div>  
                </div>
                <br>
            </form> 
